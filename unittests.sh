...
for UNITTEST in $(find . -name '*_test.go' -a -not -path '*/nfs/test/e2e/*' -prune -a -not -path '*/snapshot/pkg/cloudprovider/providers/aws/*' -prune -a -not -path '*/openebs/pkg/v1/*' -prune -a -not -path '*/vendor/*')
do
